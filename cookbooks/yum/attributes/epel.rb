...
when "amazon"
  ...
  default['yum']['epel']['url'] = "https://mirrors.fedoraproject.org/mirrorlist?repo=epel-#{node['platform_version'].to_i}&arch=$basearch"
  default['yum']['epel']['baseurl'] = ""
...
default['yum']['epel']['key_url'] = "https://dl.fedoraproject.org/pub/epel/#{node['yum']['epel']['key']}"
